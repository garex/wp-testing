...
<textarea rows="20" cols="50" placeholder="<?php echo __("Paste here your questions and they will fill fields above. Numbers and other indexes will be stripped automatically.") ?>"></textarea>
