...
.provider('digestHud', ['$provide', function($provide) {
  ...
  this.enable = function() {
    ...
    hudElement = jQuery('<div></div>');
    var buttonsElement = jQuery(
      '<div>' +
      '<span id="digestHud-refresh">refresh</span> &bull; ' +
      '<span id="digestHud-reset">reset</span> ' +
      '</div>').appendTo(hudElement);
    var summaryElement = jQuery('<div></div>').appendTo(hudElement);
    var detailsElement = jQuery('<div></div>').appendTo(hudElement);
    ...
    function refreshDetails() {
      ...
      jQuery('<div>\u2007Total\u2007\u2007\u2007Watch\u2007Work\u2007Overhead\u2007\u2007Function</div>')
      ...
      jQuery('<div></div>').text(footer).appendTo(detailsElement);
